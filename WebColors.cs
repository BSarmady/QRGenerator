...
namespace QRGen {
    ...
    public partial class WebColors: Form {
        ...
        Dictionary<string, Dictionary<string, string>> colors = new Dictionary<string, Dictionary<string, string>> {
            ...
            { "Deep Purple", new Dictionary<string, string> {
                { "50", "#EDE7F6" },
                { "100", "#D1C4E9" },
                { "200", "#B39DDB" },
                { "300", "#9575CD" },
            ...
            { "Light Blue", new Dictionary<string, string> {
                { "50", "#E1F5FE" },
                { "100", "#B3E5FC" },
                { "200", "#81D4FA" },
                { "300", "#4FC3F7" },
            ...
            { "Light Green", new Dictionary<string, string> {
                { "50", "#F1F8E9" },
                { "100", "#DCEDC8" },
                { "200", "#C5E1A5" },
                { "300", "#AED581" },
            ...
            { "Deep Orange", new Dictionary<string, string> {
                { "50", "#FBE9E7" },
                { "100", "#FFCCBC" },
                { "200", "#FFAB91" },
                { "300", "#FF8A65" },
            ...
            { "Blue Gray", new Dictionary<string, string> {
                { "50", "#ECEFF1" },
                { "100", "#CFD8DC" },
                { "200", "#B0BEC5" },
                { "300", "#90A4AE" },
        ...
        private void WebColors_Load(object sender, EventArgs e) {
            ...
            int xborder = Width - ClientSize.Width;
            int yborder = Height - ClientSize.Height;
            int y = 8;
            foreach (KeyValuePair<string, Dictionary<string, string>> colorset in colors) {
                int x = 8;
                int count = 0;
                foreach (string color in colorset.Value.Values) {
                    Label lbl = new Label();
                    lbl.Text = "";
                    lbl.AutoSize = false;
                    lbl.Size = new Size(size, size);
                    lbl.BackColor = ColorTranslator.FromHtml(color);
        ...
        private void WebColors_KeyPress(object sender, KeyPressEventArgs e) {
            if (e.KeyChar == 27)
                this.Close();
        }
    }
